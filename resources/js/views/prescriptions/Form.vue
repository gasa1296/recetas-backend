        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
            ...
            <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div class="relative">
                    ...
                    />
                    <div v-if="showPatientDropdown && patientSearch" class="absolute z-10 mt-1 w-full bg-white  border border-gray-200  rounded-md shadow-lg max-h-60 overflow-y-auto">
                        <div
            ...
            <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select v-model="form.room_id" class="w-full px-3 py-2 border border-gray-300  rounded-md bg-white  text-gray-900 ">
                    ...
                    <div>
                        ...
                        <select v-model="form.specialty_id" class="w-full px-3 py-2 border border-gray-300  rounded-md bg-white  text-gray-900 ">
            ...
            <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    <div>
                        ...
                        <input v-model="form.temp" type="number" step="0.1" class="w-full px-3 py-2 border border-gray-300  rounded-md bg-white  text-gray-900 " />
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Weight</label>
                        <input v-model="form.weight" type="number" step="0.1" class="w-full px-3 py-2 border border-gray-300  rounded-md bg-white  text-gray-900 " />
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Height</label>
                        <input v-model="form.height" type="number" step="0.1" class="w-full px-3 py-2 border border-gray-300  rounded-md bg-white  text-gray-900 " />
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Pressure</label>
                        <input v-model="form.pressure" class="w-full px-3 py-2 border border-gray-300  rounded-md bg-white  text-gray-900 " />
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Saturation</label>
                        <input v-model="form.saturation" type="number" step="0.1" class="w-full px-3 py-2 border border-gray-300  rounded-md bg-white  text-gray-900 " />
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">PPM</label>
                        <input v-model="form.ppm" type="number" class="w-full px-3 py-2 border border-gray-300  rounded-md bg-white  text-gray-900 " />
                    </div>
                </div>
            </section>
            ...
            <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div>
                    ...
                    <input v-model="form.allergy" class="w-full px-3 py-2 border border-gray-300  rounded-md bg-white  text-gray-900 " />
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Diagnostic *</label>
                    <textarea v-model="form.diagnostic" required rows="2" class="w-full px-3 py-2 border border-gray-300  rounded-md bg-white  text-gray-900 "></textarea>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Diet</label>
                    <textarea v-model="form.diet" rows="2" class="w-full px-3 py-2 border border-gray-300  rounded-md bg-white  text-gray-900 "></textarea>
                </div>
            </section>
            ...
            <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div class="relative">
                    <input
                        ...
                        class="w-full px-3 py-2 border border-gray-300  rounded-md bg-white  text-gray-900 "
                    />
                    <div v-if="showMedicamentDropdown && medicamentSearch" class="absolute z-10 mt-1 w-full bg-white  border border-gray-200  rounded-md shadow-lg max-h-60 overflow-y-auto">
                        <div
                ...
                <div v-for="(med, i) in form.medicaments" :key="i" class="flex items-end gap-3 border-b border-gray-100 pb-4 last:border-0">
                    <div class="flex-1">
                        <p class="block text-lg font-bold   mb-1">{{ med.salt }}</p>
                    </div>
                    <div class="w-24">
                        <label class="block text-xs font-medium   mb-1">Dosage</label>
                        <input v-model="med.dosage" class="w-full px-3 py-2 border border-gray-300  rounded-md bg-white  text-gray-900 " />
                    </div>
                    <div class="w-28">
                        <label class="block text-xs font-medium   mb-1">Frequency</label>
                        <input v-model="med.frequency" class="w-full px-3 py-2 border border-gray-300  rounded-md bg-white  text-gray-900 " />
                    </div>
                    <div class="w-24">
                        <label class="block text-xs font-medium   mb-1">Duration</label>
                        <input v-model="med.duration" class="w-full px-3 py-2 border border-gray-300  rounded-md bg-white  text-gray-900 " />
                    </div>
            ...
            <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div>
                    ...
                    <textarea v-model="form.comments" rows="2" class="w-full px-3 py-2 border border-gray-300  rounded-md bg-white  text-gray-900 "></textarea>
                </div>
            </section>

            <div class="flex gap-3 border-t border-slate-200 pt-4">
                <button type="submit" :disabled="loading" class="px-5 py-3 rounded-xl bg-brand-primary text-white font-semibold shadow-sm hover:bg-slate-800 transition disabled:opacity-50">
                    {{ loading ? 'Saving...' : 'Save' }}
                </button>
                <router-link :to="{ name: 'prescriptions.index' }" class="px-5 py-3 rounded-xl bg-slate-100 text-slate-700 font-semibold hover:bg-slate-200 transition">
                    Cancel
                </router-link>
            </div>
        </form>
