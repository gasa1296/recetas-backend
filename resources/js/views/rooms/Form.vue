...
async function handleSubmit() {
    ...
    try {
        ...
        error.value =(err as any).response?.data?.message || 'Error al guardar el consultorio'
    }
}
</script>
...
<template>
    <div>
        <h1 class="text-2xl font-bold text-brand-primary mb-6">{{ isEdit ? 'Editar consultorio' : 'Crear consultorio' }}</h1>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        ...
                        <button type="button" @click="addPhone" class="text-sm text-brand-primary hover:underline">+ Agregar teléfono</button>
                    </div>
                </div>
            </div>
