...
import ConfirmRecipes from "../Patients/ConfirmRecipes";
import Sign from "../Patients/Sign";
        ...
        <section className=" px-2 md:px-8 mt-4 ">
            <div className=" container-dashboard">
                <button
                    ...
                    className="button-BlacK flex justify-center items-center p-2 w-[150px] "
                >
                    <MdOutlineArrowBackIos size={20} />{" "}
                    <p className="ms-1"> Volver al inicio</p>{" "}
                </button>
            </div>
