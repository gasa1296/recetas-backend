...
export default function ConfirmRecipes({ nextStep, backStep }: any) {
    ...
    const fields: Field[] = [
        ...
        },
        {
            ...
            type: "text",
            width: 30,
            default: confirmRecipForm?.temperature,
        },
        {
            label: "Peso (kg)",
            name: "weight",
        ...
        },
        {
            ...
            type: "textarea",
            width: 100,
            default: confirmRecipForm?.indications,
        },
        {
            label: "Separation",
            name: "title",
